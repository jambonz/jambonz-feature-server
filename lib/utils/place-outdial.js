...
class SingleDialer extends Emitter {
  constructor({logger, sbcAddress, target, opts, application, callInfo, accountInfo, rootSpan}) {
    super();
    assert(target.type);
...
function placeOutdial({logger, srf, ms, sbcAddress, target, opts, application, callInfo, accountInfo, rootSpan}) {
  const myOpts = deepcopy(opts);
  const sd = new SingleDialer({logger, sbcAddress, target, myOpts, application, callInfo, accountInfo, rootSpan});
