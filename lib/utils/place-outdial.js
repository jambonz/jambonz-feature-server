...
function placeOutdial({logger, srf, ms, sbcAddress, target, opts, application, callInfo, accountInfo, rootSpan, span}) {
  const myOpts = deepcopy(opts);
  const sd = new SingleDialer({logger, sbcAddress, target, myOpts, application, callInfo, accountInfo, rootSpan, span});
