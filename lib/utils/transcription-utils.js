...
module.exports = (logger) => {
  ...
  const setChannelVarsForStt = (task, sttCredentials, language, rOpts = {}) => {
    ...
    if ('google' === vendor) {
      ...
      const serviceVersion = rOpts.assemblyAiOptions?.serviceVersion || sttCredentials.serviceVersion || 'v2';
      const {
        format_turns,
      ...
      opts = {
        ...
        ...(min_end_of_turn_silence_when_confident && {
          ASSEMBLYAI_MIN_END_OF_TURN_SILENCE_WHEN_CONFIDENT: min_end_of_turn_silence_when_confident
        }),
        ...(max_turn_silence && {
