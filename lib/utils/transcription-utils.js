  ...
  const setChannelVarsForStt = (task, sttCredentials, language, rOpts = {}) => {
    ...
    if ('google' === vendor) {
      ...
      opts = {
        ...
        ...(rOpts.altLanguages &&
          {DEEPGRAM_SPEECH_ALTERNATIVE_LANGUAGE_CODES: [...new Set(rOpts.altLanguages)].join(',')}),
        ...(deepgramOptions.detect_language &&
          {DEEPGRAM_DETECT_LANGUAGE: deepgramOptions.detect_language === true ? 'true' : 'false'}),
      };
    }
