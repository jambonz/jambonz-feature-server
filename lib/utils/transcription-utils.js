  ...
  const setChannelVarsForStt = (task, sttCredentials, rOpts = {}) => {
    ...
    if ('google' === rOpts.vendor) {
      ...
      opts = {
        ...
        ...((rOpts.words || nvidiaOptions.wordTimeOffset) && {NVIDIA_WORD_TIME_OFFSETS: 1}),
        ...(!(rOpts.words || nvidiaOptions.wordTimeOffset) && {NVIDIA_WORD_TIME_OFFSETS: 0}),
        ...
        ...(nvidiaOptions.customConfiguration && {NVIDIA_CUSTOM_CONFIGURATION: nvidiaOptions.customConfiguration})
      };
    }
