...
module.exports = (logger) => {
  ...
  const setChannelVarsForStt = (task, sttCredentials, language, rOpts = {}) => {
    ...
    if ('google' === vendor) {
      ...
      const deepgramUri = deepgramOptions.deepgramSttUri || sttCredentials.deepgram_uri;
      const useTls = deepgramOptions.deepgramSttUseTls || sttCredentials.deepgram_use_tls;
