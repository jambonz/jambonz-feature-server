        ...
        if (cs.isInConference) {
          ...
          const onPlaybackStop = (evt) => {
            try {
              ...
              this.logger.debug({evt, playbackId, text: this.text}, 'xquanluu22');
               ...
               */
              this.logger.debug({playbackId, evt}, 'Say:exec playback-stop event xquanluu');
              ...
              if (
                ...
                // only store if playback IDs match
