...
class TaskSay extends Task {
  ...
  async exec(cs, {ep}) {
    ...
    let fallbackVoice =  this.synthesizer.fallbackVoice && this.synthesizer.fallbackVoice !== 'default' ?
    ...
    try {
      ...
      if (fallbackVendor) {
        ...
        filepath = await this._synthesizeWithSpecificVendor(cs, ep, {fallbackVendor, fallbackLanguage, fallbackVoice, fallbackLabel});
      }
    }
