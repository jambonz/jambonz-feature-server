...
class TaskSay extends TtsTask {
  ...
  async exec(cs, {ep}) {
    ...
    const label = this.taskInlcudeSynthesizer ? this.synthesizer.label : cs.speechSynthesisLabel
    ...
    const fallbackLabel =  this.taskInlcudeSynthesizer ? this.synthesizer.fallbackLabel : cs.fallbackSpeechSynthesisLabel;
