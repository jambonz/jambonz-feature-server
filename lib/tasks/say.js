  ...
  async exec(cs, {ep}) {
    ...
    try {
      ...
      const generateAudio = async(text) => {
        ...
        const childSpan = this.span.startChildSpan('tts-generation', {
          'tts.vendor': vendor,
        ...
        try {
          ...
          childSpan.setAttributes({'tts.cached': servedFromCache});
          childSpan.end();
          ...
          childSpan.endWithError('Error synthesizing tts');
          writeAlerts({
            account_sid: cs.accountSid,
