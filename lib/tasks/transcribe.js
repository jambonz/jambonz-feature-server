...
class TaskTranscribe extends SttTask {
    ...
    switch (this.vendor) {
      ...
      case 'amivoice':
        ...
        this.addCustomEventListener(ep, AmiVoiceTranscriptionEvents.Transcription,
          this._onTranscription.bind(this, cs, ep, channel));
        this.addCustomEventListener(ep,
          AmiVoiceTranscriptionEvents.Connect, this._onVendorConnect.bind(this, cs, ep));
        this.addCustomEventListener(ep, AmiVoiceTranscriptionEvents.Error, this._onRestartOnError.bind(this, cs, ep));
  ...
  _onRestartOnError(cs, ep, channel) {
    this.restartDueToError(ep, channel, 'Error in asr restart');
  }
