...
class TtsTask extends Task {
  ...
  async setTtsStreamingChannelVars(vendor, language, voice, credentials, ep) {
    ...
    const local_api_key = (this.options.api_key !== null &&
      this.options.api_key !== undefined) ? this.options.api_key : api_key;
    const local_model_id = (this.options.model_id !== null &&
      this.options.model_id !== undefined) ? this.options.model_id : model_id;
    const local_api_uri = (this.options.api_uri !== null &&
      this.options.api_uri !== undefined) ? this.options.api_uri : api_uri;
    const local_custom_tts_streaming_url = (this.options.custom_tts_streaming_url !== null &&
      // eslint-disable-next-line max-len
      this.options.custom_tts_streaming_url !== undefined) ? this.options.custom_tts_streaming_url : custom_tts_streaming_url;
    const local_auth_token = (this.options.auth_token !== null &&
      this.options.auth_token !== undefined) ? this.options.auth_token : auth_token;
    ...
    switch (vendor) {
      ...
      case 'rimelabs':
        ...
        this.logger.info(`setTtsStreamingChannelVars this.options ${this.options}`);
        obj = {
