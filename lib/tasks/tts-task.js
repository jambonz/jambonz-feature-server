...
class TtsTask extends Task {
  ...
  constructor(logger, data, parentTask) {
    ...
    this.synthesizer = this.data.synthesizer || {
      // there is no verb synthezier, use application synthesizer
      vendor: 'default',
      language: 'default',
      // There is no access to call session, use magic word for label.
      // this magic word will be replaced to application synthesizer's label
      // by task.exec function which has access to call session reference.
      label: '{jambonz_label}',
      fallbackLabel: '{jambonz_label}'
    };
