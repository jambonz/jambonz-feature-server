...
class TaskConfig extends Task {
  ...
  async exec(cs, {ep} = {}) {
    ...
    if (this.actionHookDelayAction) {
      ...
      cs.actionHookNoResponseTimeout = (this.actionHookDelayAction.noResponseTimeout || 0) * 1000;
      cs.actionHookNoResponseGiveUpTimeout = (this.actionHookDelayAction.noResponseGiveUpTimeout || 0) * 1000;
