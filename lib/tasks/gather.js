...
class TaskGather extends Task {
  constructor(logger, opts, parentTask) {
    ...
    [
      ...
      'interDigitTimeout', 'partialResultHook', 'bargein', 'dtmfBargein', 'asrTimeout', 'asrDtmfTerminationDigit',
    ...
    this.asrTimeout = typeof this.asrTimeout === 'number' ? this.asrTimeout * 1000 : 0;
  ...
  get isContinuousAsr() { return this.asrTimeout > 0; }
  ...
  _onTranscription(cs, ep, evt) {
    ...
    if (evt.is_final) {
      ...
      if (this.isContinuousAsr) {
        ...
        this._clearTimer();
        this._startAsrTimer();
        return this._startTranscribing();
      }
