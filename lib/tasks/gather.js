...
class TaskGather extends SttTask {
  constructor(logger, opts, parentTask) {
    ...
    // Buffer for fast recognition transcripts
    this._fastRecognitionTranscripts = [];
  }
  ...
  _startFastRecognitionTimer(evt) {
    ...
    this._fastRecognitionTranscripts.push(evt);
    this._clearFastRecognitionTimer();
    this._fastRecognitionTimer = setTimeout(() => {
      const lastEvt = this._fastRecognitionTranscripts.pop();
      compileTranscripts(this.logger, lastEvt, this._fastRecognitionTranscripts);
      this._resolve('speech', lastEvt);
