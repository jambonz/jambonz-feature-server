...
class TaskGather extends Task {
  ...
  async _recognizeWithSpecificProvider(cs, ep, {vendor, language, label}) {
  ...
  async exec(cs, {ep}) {
    ...
    const fallback = async() => {
      ...
      this.logger.info(`Failed to initiate speech credential for primary provider, fallback to ${this.fallbackVendor}`);
