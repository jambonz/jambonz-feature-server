...
class TaskGather extends SttTask {
  constructor(logger, opts, parentTask) {
    ...
    if (this.data.recognizer) {
      ...
      this.asrTimeout = typeof this.data.recognize.asrTimeout === 'number' ? this.data.recognize.asrTimeout * 1000 : 0;
      if (this.asrTimeout > 0) this.asrDtmfTerminationDigit = this.data.recognize.asrDtmfTerminationDigit;
