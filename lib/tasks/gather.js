  ...
  async _setSpeechHandlers(cs, ep) {
    ...
    switch (this.vendor) {
      ...
      case 'deepgram':
        ...
        this.addCustomEventListener(ep, DeepgramTranscriptionEvents.VadDetected,
          this._onVadDetected.bind(this, cs, ep));
        break;
      ...
      case 'soniox':
        ...
        this.addCustomEventListener(ep, SonioxTranscriptionEvents.VadDetected,
          this._onVadDetected.bind(this, cs, ep));
        break;
      ...
      case 'cobalt':
        ...
        this.addCustomEventListener(ep, CobaltTranscriptionEvents.VadDetected,
          this._onVadDetected.bind(this, cs, ep));
      ...
      case 'ibm':
        ...
        this.addCustomEventListener(ep, IbmTranscriptionEvents.ConnectFailure,
          this._onVendorConnectFailure.bind(this, cs, ep));
        this.addCustomEventListener(ep, IbmTranscriptionEvents.VadDetected,
          this._onVadDetected.bind(this, cs, ep));
        break;
      ...
      case 'assemblyai':
        ...
        this.addCustomEventListener(ep, AssemblyAiTranscriptionEvents.ConnectFailure,
          this._onVendorConnectFailure.bind(this, cs, ep));
        this.addCustomEventListener(ep, AssemblyAiTranscriptionEvents.VadDetected,
          this._onVadDetected.bind(this, cs, ep));
        break;
      default:
        if (this.vendor.startsWith('custom:')) {
          ...
          this.addCustomEventListener(ep, JambonzTranscriptionEvents.ConnectFailure,
            this._onVendorConnectFailure.bind(this, cs, ep));
          this.addCustomEventListener(ep, JambonzTranscriptionEvents.VadDetected,
            this._onVadDetected.bind(this, cs, ep));
          break;
        }
        else {
