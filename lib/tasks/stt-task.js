...
class SttTask extends Task {
  ...
  get canFallback() {
    return this.fallbackVendor && this.isHandledByPrimaryProvider && !this.cs.isFallbackAsr;
  }

  /**
   * called when STT task in error and start to fallback to 2nd configuration.
