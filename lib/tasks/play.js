...
class TaskPlay extends Task {
  ...
  async exec(cs, {ep}) {
    ...
    try {
      ...
      while (!this.killed && (this.loop === 'forever' || this.loop--) && this.ep && this.ep.connected) {
        ...
        if (this.ep && this.ep.connected) {
          ...
          this.logger.info({callSid: cs.callSid}, 'TaskPlay: ep was null or disconnected, skipping playback-start handler');
        }
