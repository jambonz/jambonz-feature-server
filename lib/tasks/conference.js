...
class Conference extends Task {
  ...
  async kill(cs) {
    ...
    if (this.ep && this.ep.connected) {
      // IMPORTANT!!!! Remove CUSTOM event will make the ep is longer usable for any orther activity
      // all freeswitch modules are firing CUSTOM events
      // There is issue after caller is kicked from conferrence, he cannot use gather/transcribe
