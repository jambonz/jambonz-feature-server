...
class TaskListen extends Task {
  constructor(logger, opts, parentTask) {
    ...
    [
      ...
      'sampleRate', 'timeout', 'transcribe', 'wsAuth', 'disableBidirectionalAudio', 'bidirectionalAudioSampleRate'
  ...
  async _startListening(cs, ep) {
    ...
    await ep.forkAudioStart({
      ...
      metadata,
      ...(this.bidirectionalAudioSampleRate && {bidirectionalAudioSampleRate: this.bidirectionalAudioSampleRate})
    });
