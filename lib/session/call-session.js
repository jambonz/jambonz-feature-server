 ...
 */
  ...
  */
   ...
   */
  async replaceApplication(tasks) {
    if (this.callGone) {
    ...
    this.taskIdx = 0;
    this.stackIdx++;
    if (this.currentTask.name === TaskName.Dial && isOnhold(this.currentTask.sd.ep.remote.sdp)) {
      this.logger.info('Media session has been on hold. Releasing it');
