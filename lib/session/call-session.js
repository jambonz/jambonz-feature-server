...
Duration=${duration} `
 ...
 got response to INFO DTMF digit=${digit} and duration=${duration}`);
   ...
   */
  async _notifyCallStatusChange({callStatus, sipStatus, sipReason, duration, headers, msg}) {
    ...
    this.callInfo.updateCallStatus(callStatus, sipStatus, sipReason, reasonHeaderFromSipMessage(msg));
