    ...
    if (this._actionHookDelayProcessor) {
      ...
      try {
        ...
        this._actionHookDelayProcessor.on('giveupWithTasks', (tasks) => {
          ...
          // need to check whether below condition is needed as wakeupResolver is made to null in replaceApplication
          if (this.wakeupResolver) {
            this.wakeupResolver({reason: 'noResponseGiveUpActions'});
            this.wakeupResolver = null;
          }
        });
      } catch (err) {
