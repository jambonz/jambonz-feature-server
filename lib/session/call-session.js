...
const {
  ...
  JAMBONES_MEDIA_TIMEOUT,
  JAMBONES_MEDIA_HOLD_TIMEOUT
} = require('../config');
 ...
 got response to INFO DTMF digit=${digit} and duration=${duration}`);
  ...
  _configMsEndpoint() {
    ...
    const opts = {
      ...
      ...(JAMBONES_MEDIA_TIMEOUT && {media_timeout: JAMBONES_MEDIA_TIMEOUT}),
      ...(JAMBONES_MEDIA_HOLD_TIMEOUT && {media_hold_timeout: JAMBONES_MEDIA_HOLD_TIMEOUT})
    };
