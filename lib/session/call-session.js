 ...
 */
  ...
  async enableBotMode(gather) {
    this.logger.info({gather}, 'CallSession:enableBotMode');
    try {
      this.backgroundGatherTask = makeTask(this.logger, {gather});
  ...
  */
  ...
  _onBackgroundSpeech(evt) {
    this.logger.info({evt}, 'CallSession:_onBackgroundSpeech');
  }
  _onBackgroundTimeout(evt) {
    this.logger.info({evt}, 'CallSession:_onBackgroundTimeout');
  }
}
