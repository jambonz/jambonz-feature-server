...
const ConfirmCallSession = require('./confirm-call-session');
  ...
  async exec() {
    ...
    while (this.tasks.length && !this.callGone) {
      ...
      if (0 === this.tasks.length &&
        ...
        !this.callGone &&
        // ConfirmCallSession is for short temp list of tasks, should not be hold
        !(this instanceof ConfirmCallSession)
      ) {
        try {
