    ...
    try {
      ...
      */
      ...
      if (app.transferredCall && app.callInfo) {
        req.locals.callInfo = {
          ...req.locals.callInfo,
          callerName: app.callInfo.callerName,
          from: app.callInfo.from,
          to: app.callInfo.to,
          originatingSipIp: app.callInfo.originatingSipIp,
          originatingSipTrunkName: app.callInfo.originatingSipTrunkName
        };
